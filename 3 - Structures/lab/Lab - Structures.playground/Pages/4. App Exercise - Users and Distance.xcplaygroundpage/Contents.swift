 ...
 */
var Shamir = User(name: "Shamir", age: 16, height: 70, weight: 143.3, activityLevel: 5)
print("My name is \(Shamir.name) and I am \(Shamir.age) years old. I am \(Shamir.height) feet tall and weigh \(Shamir.weight) pounds. My activity level is \(Shamir.activityLevel).")
/*:
