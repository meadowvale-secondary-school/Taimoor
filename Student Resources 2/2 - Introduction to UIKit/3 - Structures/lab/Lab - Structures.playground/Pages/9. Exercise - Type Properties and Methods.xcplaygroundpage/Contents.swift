 ...
 */
struct User {
    static var currentUser: User = User(userName: "xx_Taimoor_xx", email: "Taimoor@gmail.com", age: 16)
    static func logIn(currentLoggedInUser: User) {
        currentUser = currentLoggedInUser
        print("\(currentUser.userName) is currently logged in.")
    }
    var userName: String
    var email: String
    var age: Int
 ...
 */
let myUser = User(userName: "xx_WWE_xx", email: "WWE@gmail.com", age: 20)
User.logIn(currentLoggedInUser: myUser)
