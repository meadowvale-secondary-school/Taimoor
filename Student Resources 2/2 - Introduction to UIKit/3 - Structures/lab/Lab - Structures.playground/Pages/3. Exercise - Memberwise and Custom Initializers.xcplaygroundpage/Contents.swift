...
let favoriteBook = Book(title: "The Dairy of a Wimpy Kid", author: "Jeff Kinney", pages: 218, price: 16.95)

print("My favourite book is \(favoriteBook.title) and it was written by \(favoriteBook.author). It cost $\(favoriteBook.price) and has \(favoriteBook.pages) pages.")
/*:
 ...
 */
var someoneHeight = Height(heightInInches: 65)
print(someoneHeight.heightInCentimeters)
print(someoneHeight.heightInInches)
 ...
 */
var myHeight = Height(heightInInches: 80)
