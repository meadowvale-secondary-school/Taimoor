 ...
 */
var Taimoor = User(name: "Taimoor", age: 16, height: 80, weight: 143.3, activityLevel: 5)
print("My name is \(Taimoor.name) and I am \(Taimoor.age) years old. I am \(Taimoor.height) feet tall and weigh \(Taimoor.weight) pounds. My activity level is \(Taimoor.activityLevel).")
/*:
 ...
 */
var someOtherDistance = Distance(feet: 2000)
