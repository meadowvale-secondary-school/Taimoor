 ...
 */
var provincesandCapitals: [String:String] = ["Manitoba'": "Winnipeg","Ontario":"Toronto", "Alberta": "Edmonton"]

for (province, capital) in provincesandCapitals {
    print("\(province)'s capital is \(capital). ")
    if province == "Ontario" {
