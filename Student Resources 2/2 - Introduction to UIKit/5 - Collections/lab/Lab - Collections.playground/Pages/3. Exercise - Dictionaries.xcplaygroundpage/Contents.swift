 ...
 */
if let daysInJanuary = numberofDays["January"] {
...
var anotherDictionary: [String:[String]] = ["Shapes": shapesArray, "Colors": colorsArray]
/*:
 ...
 */
if let lastColorsArray =  anotherDictionary["Colors"] {
    print(lastColorsArray[2])
}
