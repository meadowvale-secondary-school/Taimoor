...
let lunch = mealInfo(myMeal: "Breakfast")
let breakfast = mealInfo(myMeal: "Lunch")
print(lunch)
print(breakfast)
/*:
 ...
 */
func checkSavedInfo () -> [String:Any] {
    
    if let myInfo = UserDefaults.standard.dictionary(forKey: "mealLog") {
        return myInfo
    } else {
        return [:]
    }
