...
func checkAge (age:String) -> Int? {
    if let verifyAge = Int(age) {
        ...
        print("Sorry, something went wrong. Can you plase re-enter your age.")
        return nil
    }
}
...
let costOfChips = costOfItem(item: "Chips")
let costOfDonuts = costOfItem(item: "Donuts")
print(costOfChips)
print(costOfDonuts)
