...
let hearRate2 = 85
let hearRate3 = 99
let addedHR = hearRate1 + hearRate2 + hearRate3
 ...
 */
let hearRate1D:Double = 75
let hearRate2D:Double = 85
let hearRate3D:Double = 99
let addedHRD = hearRate1D + hearRate2D + hearRate3D
