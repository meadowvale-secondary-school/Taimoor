...
let isInTarget = currentHR
let isBelowTarget = targetLowerBound
let isAboveTarget = targetUpperBound

if currentHR < 120 {
    print("Your're doing great, but try to push it a bit!")
}
else if currentHR > 150 {
    print("You're on fire!Slow down a bit")
}
else {
