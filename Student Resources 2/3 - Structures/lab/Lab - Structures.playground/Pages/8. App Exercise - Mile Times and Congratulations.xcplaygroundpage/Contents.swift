...
var currentWorkout = RunningWorkout(distance: 100, time: 50, elevation: 20)
print(currentWorkout.averageMileTime)
...
var workoutToday = Steps(steps: 499, goal: 500)
workoutToday.takeStep()
