...
*/
let wakingUp = 5
let eatingBreakfast = 10
let brushingTeeth = 5
let gettingReady = 10
let thingsIHaveToDo = wakingUp + eatingBreakfast + brushTeeth + gettingReady

let watchingYoutube = 60
let workingOut = 90
let napping = 30
let thingsILikeToDo = watchingYoutube + workingOut + napping
